...
public class Simulator {
	...
	/** Simulation advances normally, last state is put (created or overwritten) into Mastodon,
	 *  but Mastodon advances time point only after this number of simulated rounds. */
	public static int MASTODON_KEEPS_EVERY_ROUND = 1;
	...
	public static void setParamsFromConfig(final SimulationConfig c) {
		...
		MASTODON_KEEPS_EVERY_ROUND = c.MASTODON_KEEPS_EVERY_ROUND;
	}
	...
	public String toString() {
		return "Simulation parameters:\n" + "  LABELS_NAMING_POLICY: " + LABELS_NAMING_POLICY +
				...
				"\n  MASTODON_KEEPS_EVERY_ROUND: " + MASTODON_KEEPS_EVERY_ROUND;
	}
